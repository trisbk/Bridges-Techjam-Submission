"""Post-freeze analysis: retrain the final recipe for daily feature updates.

Unlike the earlier staleness test, this rebuilds both training and evaluation
features using only history from completed previous days, then retrains the
five-seed committee from scratch. This gives a fair measurement of how the
model would perform with a realistic daily feature-refresh schedule.
"""
...
def build_daily_features():
    splits = load_sequenced()   # loads rows
    vid2tag = {}
