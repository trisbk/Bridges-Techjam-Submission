"""Run 10: testing a nonlinear MLP under the listwise objective.

Instead of FM's second-order interactions, the MLP combines all feature
embeddings through a hidden ReLU layer, allowing it to learn more flexible
relationships. This adds capacity but also more variance, so two learning
rates are tested across three seeds through the standard harness.
"""
import numpy as np
